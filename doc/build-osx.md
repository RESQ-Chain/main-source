# Mac OS X Renesisd Build Instructions
...
* See readme-qt.rst for instructions on building Renesis QT, the
...
## Useful commands
    ...
    ./Renesisd --help  # for a list of command-line options.
    ./Renesisd -daemon # to start the Renesis daemon.
    ./Renesisd help    # When the daemon is running, to get a list of RPC commands
