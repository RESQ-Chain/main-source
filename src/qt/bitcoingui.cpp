...
#ifdef Q_OS_MAC
    resize(960, 595);
    setWindowTitle(tr("Renesis - MacOS wallet"));
#elif _WIN32
    resize(900, 580);
    setWindowTitle(tr("Renesis - Windows wallet"));
#else
    resize(1000, 630);
    setWindowTitle(tr("Renesis - Linux wallet"));
#endif
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Renesis address"));
    ...
    aboutAction = new QAction(tr("&About Renesis"), this);
    aboutAction->setToolTip(tr("Show information about Renesis"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for Renesis"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Renesis client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Renesis client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Renesis network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Renesis address or malformed URI parameters."));
    }
