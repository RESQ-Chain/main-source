...
// Copyright (c) 2018 Hav0k. Rensis Algo Developer
...
static const int64_t COIN_YEAR_REWARD = 10 * CENT; // 10% per year reward
...
inline int64_t MainNetDrift(int64_t nTime) { return nTime + 10 * 60; } // Changed for the best
...
public:
    ...
    {
		return renesis(BEGIN(nVersion), END(nNonce));
    }
